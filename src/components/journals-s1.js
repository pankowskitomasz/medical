...
class JournalsS1 extends Component{
    render(){
        return(    
            <Container fluid className="journals-s1 d-flex minh-50vh align-items-center py-5 border-top border-secondary pt-5">
