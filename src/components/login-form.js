            ...
            <Container fluid className={"login-form align-items-center p-0 py-5 d-flex minh-100vh "+this.props.classExt}>
                <Row className="mx-auto text-start w-100 pt-5">
                    <Col xs={11} md={5} lg={4} className="mx-auto p-0 d-flex align-items-center">
                        <Form className="text-start w-100 border border-dark-blue p-4 rounded bg-form shadow text-dark-blue fw-bold z-index-10"
                            autoComplete="off"
                            method="POST">
                            <div className="border-bottom border-dark-blue mb-4">
                            ...
                            <Form.Group controlId="formLogin">
                                <Form.Label>Login</Form.Label>
                                 <Form.Control type="text" 
                                    ...
                                    className="rounded-pill border-dark-blue bg-blue text-white"
                                    maxLength="50"
                                    name="userName"
                            ...
                            <div className="w-100 text-start py-3">
                                <p className="text-dark-blue fw-normal">
                                    Not registered? 
                                    <Link to={this.props.backLink.href} className="text-dark-blue fw-bold text-decoration-none">
                            ...
                            <div className="w-100 text-end py-1">
                                <Button 
                                    ...
                                    type="reset" 
                                    className="mx-1 rounded-pill border-dark-blue text-dark-blue">
                                    Clear
                                </Button>
